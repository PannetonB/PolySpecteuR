...
{  
  ...
  Ref_Inst <- InitReflectSpecteuR()   #instrument pour Fluorescence  #options
  if (is.character(Ref_Inst)) return( "ABANDON")                     #options 
  
  lesInstruments <- list(Ref_Inst)                                   #options
