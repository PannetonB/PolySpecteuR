 ...
 #************************************************************************************
  ...
  #___________________________________________________________________________
  #Définir les paramêtres d'acquisition pour la vérification périodique
  #___________________________________________________________________________________
  Instr_reps = 1  # nombre de reps pour mesure du facteur de normalisation
  
  Instr_T_exp_test = list(          
    HRU = c(4,2,4,4,2,1,1),
    STA6 = c(100,200,100,100,150,75,100)
  ) #pour les DELs 1 ? 8 respectivement, msec  
  
  Instr_N_scans_test = list(
    HRU = c(250,500,250,250,500,1000,1000),
    STA6 = c(10,10,20,15,15,15,15)
  )  #pour les DELs 1 ? 8 respectivement
  ...
  ) #pour les DELs 1 ? 8 respectivement, mamp
  
  Instrument_Verif_File="Fichiers_Instruments/SAAC2_HS6_VerifHS6.txt"
  
  #_____________________________________________________________________________
  #Paramêtres pour la longueur d'onde d'observation pour la normalisation de la fluorescence
  #_____________________________________________________________________________
