  ...
  DoEX1=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  # Position 2
  DoEX2=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  # Position 3
  DoEX3=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  # Position 4
  DoEX4=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  # Position 5
  DoEX5=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  # Position 6
  DoEX6=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  # Position 7
  DoEX7=FALSE    # TRUE - on prend la fluo � cette longueur d'onde d'excitation
  ...
  EX8=440       # Longueur d'onde de la DEL
  ...
  fluo_l_max=875  #longueur d'onde maximale
  ...
  #************************************************************************************
  T_Reflect=24    # temps d'exposition en msec
  Box_Reflect=1     # Boxcar pour l'acquisition
  Scans_Reflect=180   # nombre de scans par acquisition

  # Plage et intervalle de longueur d'onde pour l'interpolation
  reflect_l_min=300  #longueur d'onde minimale
  reflect_l_max=1100  #longueur d'onde maximale
  reflect_step=1     #pas de longueur d'onde.
  
  stray_low=290      #d�but de la plage de longueur d'onde pour �valuer stray light
  stray_high=315     #fin de la plage de longueur d'onde pour �valuer stray light
